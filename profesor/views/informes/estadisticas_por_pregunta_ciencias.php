...
foreach($PruebasInformeProfesor['Ejes'] as $ramo){
    ...
    foreach ($Ejes as $eje) {
        ...
        $Habilidad = ArrayHelper::index($eje,null, 'habilidad_id');


        $ibE = $ibh;
        foreach ($Habilidad as $habilidad) {
            $habilidad_id = $habilidad[0]["habilidad_id"];
            $habilidad_nombre = $habilidad[0]["nombre_habilidad"];
        ...
        // $objPHPExcel->getActiveSheet()->getStyle('B' . $ibE . ':G'.$ibh_final)->getBorders()->applyFromArray(
        //      array(
        //          'left'     => array(
        //              'style' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
        //              'color' => array(
