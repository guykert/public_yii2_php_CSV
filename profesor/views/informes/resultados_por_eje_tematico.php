...
$objPHPExcel->setActiveSheetIndex(0)->mergeCells('A3:A3')
            ->setCellValue('A3', 'Porcentaje medio de respuestas correctas Eje Temático');
...
foreach($PruebasInformeProfesor['Ejes'] as $eje){
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('C' . $i, $eje["porcentaje_buenas"]);
    $objPHPExcel->getActiveSheet()->setCellValue('D' . $i, $eje["calificacion_buenas"]);
...
$objPHPExcel->setActiveSheetIndex(0)->mergeCells('A' . $i . ':A' . $i)
            ->setCellValue('A' . $i, 'Porcentaje medio de respuestas erradas Eje Temático');
...
foreach($PruebasInformeProfesor['Ejes'] as $eje){
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('B' . $i, $eje["cantidad_preguntas"]);
    $objPHPExcel->getActiveSheet()->setCellValue('C' . $i, $eje["porcentaje_malas"]);
    $objPHPExcel->getActiveSheet()->setCellValue('D' . $i, $eje["calificacion_malas"]);
...
$objPHPExcel->setActiveSheetIndex(0)->mergeCells('A' . $i . ':A' . $i)
            ->setCellValue('A' . $i, 'Porcentaje medio de respuestas omitidas Eje Temático');
$objPHPExcel->getActiveSheet()->getStyle('A' . $i)->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
$objPHPExcel->getActiveSheet()->getStyle('A')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
$objPHPExcel->getActiveSheet()->getStyle('A' . $i)->getAlignment()->setVertical(\PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_CENTER);
$objPHPExcel->getActiveSheet()->getStyle('A' . $i)->getFont()->setBold(true);
