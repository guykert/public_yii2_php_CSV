...
$objPHPExcel->setActiveSheetIndex(0)->mergeCells('A3:A3')
            ->setCellValue('A3', 'Porcentaje medio de respuestas correctas Habilidad Cognitiva');
...
$objPHPExcel->setActiveSheetIndex(0)->mergeCells('B3:B3')
            ->setCellValue('B3', 'Cantidad de Preguntas');
...
$objPHPExcel->setActiveSheetIndex(0)->mergeCells('C3:C3')
            ->setCellValue('C3', '% Promedio del Grupo');
...
$objPHPExcel->setActiveSheetIndex(0)->mergeCells('D3:D3')
            ->setCellValue('D3', 'Nivel de Desempeño');
...
$objPHPExcel->setActiveSheetIndex(0)->mergeCells('E3:E3')
            ->setCellValue('E3', 'Descripción de niveles');
...
$objPHPExcel->getActiveSheet()->getStyle('A3:E3')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID);
$objPHPExcel->getActiveSheet()->getStyle('A3:E3')->getFill()->getStartColor()->setRGB('005085');
$objPHPExcel->getActiveSheet()->getStyle('A3:E3')->getBorders()->getBottom()->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THICK);
$objPHPExcel->getActiveSheet()->getStyle('A3:E3')->getBorders()->getBottom()->getColor()->setARGB(\PhpOffice\PhpSpreadsheet\Style\Color::COLOR_WHITE);



$objPHPExcel->getActiveSheet()->getStyle('A3:E3')->getBorders()->applyFromArray(
     array(
         'left'     => array(
             'style' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
             'color' => array(
...
$objPHPExcel->getActiveSheet()->setCellValue('E' . ($i), 'Alto > 80%');
$objPHPExcel->getActiveSheet()->setCellValue('E' . ($i + 1), 'Medio Alto > 60% <= 80%');
$objPHPExcel->getActiveSheet()->setCellValue('E' . ($i + 2), 'Medio > 40% <= 60%');
$objPHPExcel->getActiveSheet()->setCellValue('E' . ($i + 3), 'Medio Bajo >= 30% <= 40%');
$objPHPExcel->getActiveSheet()->setCellValue('E' . ($i + 4), 'Bajo < 30%');


foreach($PruebasInformeProfesor['Habilidad'] as $habilidad){


    $objPHPExcel->getActiveSheet()->setCellValue('A' . $i, $habilidad["nombre"]);
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('B' . $i, $habilidad["cantidad_preguntas"]);
    $objPHPExcel->getActiveSheet()->setCellValue('C' . $i, $habilidad["porcentaje_buenas"]);
    $objPHPExcel->getActiveSheet()->setCellValue('D' . $i, $habilidad["calificacion_buenas"]);
...
$objPHPExcel->setActiveSheetIndex(0)->mergeCells('A' . $i . ':A' . $i)
            ->setCellValue('A' . $i, 'Porcentaje medio de respuestas erradas Habilidad Cognitiva');
...
$objPHPExcel->setActiveSheetIndex(0)->mergeCells('B' . $i . ':B' . $i)
            ->setCellValue('B' . $i, 'Cantidad de Preguntas');
...
$objPHPExcel->setActiveSheetIndex(0)->mergeCells('C' . $i . ':C' . $i)
            ->setCellValue('C' . $i, '% Promedio del Grupo');
...
$objPHPExcel->setActiveSheetIndex(0)->mergeCells('D' . $i . ':D' . $i)
            ->setCellValue('D' . $i, 'Nivel de Desempeño');
...
$objPHPExcel->setActiveSheetIndex(0)->mergeCells('E' . $i . ':E' . $i)
            ->setCellValue('E' . $i, 'Descripción de niveles');
...
$objPHPExcel->getActiveSheet()->getStyle('A' . $i . ':E' . $i)->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID);
$objPHPExcel->getActiveSheet()->getStyle('A' . $i . ':E' . $i)->getFill()->getStartColor()->setRGB('005085');
$objPHPExcel->getActiveSheet()->getStyle('A' . $i . ':E' . $i)->getBorders()->getBottom()->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THICK);
$objPHPExcel->getActiveSheet()->getStyle('A' . $i . ':E' . $i)->getBorders()->getBottom()->getColor()->setARGB(\PhpOffice\PhpSpreadsheet\Style\Color::COLOR_WHITE);



$objPHPExcel->getActiveSheet()->getStyle('A' . $i . ':E' . $i)->getBorders()->applyFromArray(
    array(
        'left'     => array(
            'style' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
            'color' => array(
...
$objPHPExcel->getActiveSheet()->setCellValue('E' . ($i), 'Alto <= 10%');
$objPHPExcel->getActiveSheet()->setCellValue('E' . ($i + 1), 'Medio Alto > 10% <= 20%');
$objPHPExcel->getActiveSheet()->setCellValue('E' . ($i + 2), 'Medio > 20% <= 30%');
$objPHPExcel->getActiveSheet()->setCellValue('E' . ($i + 3), 'Medio Bajo > 30% <= 40%');
$objPHPExcel->getActiveSheet()->setCellValue('E' . ($i + 4), 'Bajo > 40%');
...
foreach($PruebasInformeProfesor['Habilidad'] as $habilidad){
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('B' . $i, $habilidad["cantidad_preguntas"]);
    $objPHPExcel->getActiveSheet()->setCellValue('C' . $i, $habilidad["porcentaje_malas"]);
    $objPHPExcel->getActiveSheet()->setCellValue('D' . $i, $habilidad["calificacion_malas"]);
...
$objPHPExcel->setActiveSheetIndex(0)->mergeCells('A' . $i . ':A' . $i)
            ->setCellValue('A' . $i, 'Porcentaje medio de respuestas omitidas Habilidad Cognitiva');
$objPHPExcel->getActiveSheet()->getStyle('A' . $i)->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
$objPHPExcel->getActiveSheet()->getStyle('A')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
$objPHPExcel->getActiveSheet()->getStyle('A' . $i)->getAlignment()->setVertical(\PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_CENTER);
$objPHPExcel->getActiveSheet()->getStyle('A' . $i)->getFont()->setBold(true);
...
foreach($PruebasInformeProfesor['Habilidad'] as $habilidad){
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('B' . $i, $habilidad["cantidad_preguntas"]);
    $objPHPExcel->getActiveSheet()->setCellValue('C' . $i, $habilidad["porcentaje_omitidas"]);
    $objPHPExcel->getActiveSheet()->setCellValue('D' . $i, $habilidad["calificacion_omitidas"]);
...
header('Content-Disposition: attachment;filename="Resultados_por_habilidad_'.strtoupper($PruebasInformeProfesor['nombre_titulo']).'_'.strtoupper($PruebasInformeProfesor['nombre_prueba']).'.Xlsx"');
