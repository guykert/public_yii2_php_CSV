...
if($alumnos['puntaje'] > 0){
    $objPHPExcel->getActiveSheet()->getStyle('B' . $i)->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID);
    $objPHPExcel->getActiveSheet()->getStyle('B' . $i)->getFill()->getStartColor()->setRGB('58FF33');

    $objPHPExcel->getActiveSheet()->getStyle('B' . $i)->getBorders()->applyFromArray(
        array(
            'left'     => array(
                'style' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                'color' => array(
    ...
    $objPHPExcel->getActiveSheet()->getStyle('B' . $i)->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID);
    $objPHPExcel->getActiveSheet()->getStyle('B' . $i)->getFill()->getStartColor()->setRGB('FF6B33');
