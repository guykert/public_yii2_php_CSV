...
if (Yii::$app->user->identity->anio_predeterminado > 0) {
    // if (Yii::$app->user->identity->anio->anio_academico == date('Y')) {
        ...
        $rutaAsset = $this->assetBundles['alumno\assets\AlumnoAsset']->baseUrl."/img/";
    // }else{
    //     AlumnoAssetOtroAnio::register($this);
    //     $rutaAsset = $this->assetBundles['alumno\assets\AlumnoAssetOtroAnio']->baseUrl."/img/OtroAnio/";
    // }
}else{
    AlumnoAsset::register($this);
    $rutaAsset = $this->assetBundles['alumno\assets\AlumnoAsset']->baseUrl."/img/";
