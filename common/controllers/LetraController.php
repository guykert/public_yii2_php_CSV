...
use common\models\search\Letra as LetraSearch;
...
class LetraController extends Controller
{
    ...
    {
        /**
        * Lista todo el modelo Letra. 
        * no hay variable de retorno
        */
        $searchModel = new LetraSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('@common/views/letra/index', [
    ...
    {
        /**
        * Muestra un modelo único Letra. 
        * @param integer $id
        * no tiene variable de retorno
        */
        return $this->render('@common/views/letra/view', [
    ...
    public function actionCreate()
    {
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/letra/create', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Actualiza un modelo existente Letra.
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/letra/update', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Busca el modelo Letra en función de su llave primaria.
