...
use common\models\search\PaginaAlumnoArea as PaginaAlumnoAreaSearch;
...
/**
 * PaginaAlumnoAreaController Implementa las acciones del CRUD para el modeloPaginaAlumnoArea .
 * */ 
class PaginaAlumnoAreaController extends Controller
{
    ...
    {
        /**
        * Lista todo el modelo PaginaAlumnoArea. 
        * no hay variable de retorno
        */
        $searchModel = new PaginaAlumnoAreaSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('@common/views/pagina-alumno-area/index', [
    ...
    {
        /**
        * Muestra un modelo único PaginaAlumnoArea. 
        * @param integer $id
        * no tiene variable de retorno
        */
        return $this->render('@common/views/pagina-alumno-area/view', [
    ...
    public function actionCreate()
    {
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/pagina-alumno-area/create', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Actualiza un modelo existente PaginaAlumnoArea.
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/pagina-alumno-area/update', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Busca el modelo PaginaAlumnoArea en función de su llave primaria.
        * Si no se encuentra el modelo, se emite una excepción HTTP 404.
        * @param integer $id
        * @return PaginaAlumnoArea el modelo cargado.
        * Devuelve NotFoundHttpException si el modelo no se puede encontrar
        */

        if (($model = PaginaAlumnoArea::findOne($id)) !== null) {
            return $model;
        } else {
