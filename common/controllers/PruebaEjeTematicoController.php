...
use common\models\search\PruebaEjeTematico as PruebaEjeTematicoSearch;
...
/**
 * PruebaEjeTematicoController Implementa las acciones del CRUD para el modeloPruebaEjeTematico .
 * */ 
class PruebaEjeTematicoController extends Controller
{
    ...
    {
        /**
        * Lista todo el modelo PruebaEjeTematico. 
        * no hay variable de retorno
        */
        $searchModel = new PruebaEjeTematicoSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('@common/views/prueba-eje-tematico/index', [
    ...
    {
        /**
        * Muestra un modelo único PruebaEjeTematico. 
        * @param integer $id
        * no tiene variable de retorno
        */
        return $this->render('@common/views/prueba-eje-tematico/view', [
    ...
    public function actionCreate()
    {
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/prueba-eje-tematico/create', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Actualiza un modelo existente PruebaEjeTematico.
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/prueba-eje-tematico/update', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Busca el modelo PruebaEjeTematico en función de su llave primaria.
        * Si no se encuentra el modelo, se emite una excepción HTTP 404.
        * @param integer $id
        * @return PruebaEjeTematico el modelo cargado.
        * Devuelve NotFoundHttpException si el modelo no se puede encontrar
        */

        if (($model = PruebaEjeTematico::findOne($id)) !== null) {
            return $model;
        } else {
