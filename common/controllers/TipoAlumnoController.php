...
use Yii;
use common\models\TipoAlumno;
use common\models\search\TipoAlumno as TipoAlumnoSearch;
...
/**
 * TipoAlumnoController Implementa las acciones del CRUD para el modeloTipoAlumno .
 * */ 
class TipoAlumnoController extends Controller
{
    ...
    {
        /**
        * Lista todo el modelo TipoAlumno. 
        * no hay variable de retorno
        */
        $searchModel = new TipoAlumnoSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('@common/views/tipo-alumno/index', [
    ...
    {
        /**
        * Muestra un modelo único TipoAlumno. 
        * @param integer $id
        * no tiene variable de retorno
        */
        return $this->render('@common/views/tipo-alumno/view', [
    ...
    public function actionCreate()
    {
        ...
        /**
        * Crea un nuevo modelo TipoAlumno.
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/tipo-alumno/create', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Actualiza un modelo existente TipoAlumno.
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/tipo-alumno/update', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Busca el modelo TipoAlumno en función de su llave primaria.
        * Si no se encuentra el modelo, se emite una excepción HTTP 404.
        * @param integer $id
        * @return TipoAlumno el modelo cargado.
        * Devuelve NotFoundHttpException si el modelo no se puede encontrar
        */

        if (($model = TipoAlumno::findOne($id)) !== null) {
            return $model;
        } else {
