...
use common\models\search\PruebaHabilidad as PruebaHabilidadSearch;
...
/**
 * PruebaHabilidadController Implementa las acciones del CRUD para el modeloPruebaHabilidad .
 * */ 
class PruebaHabilidadController extends Controller
{
    ...
    {
        /**
        * Lista todo el modelo PruebaHabilidad. 
        * no hay variable de retorno
        */
        $searchModel = new PruebaHabilidadSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('@common/views/prueba-habilidad/index', [
    ...
    {
        /**
        * Muestra un modelo único PruebaHabilidad. 
        * @param integer $id
        * no tiene variable de retorno
        */
        return $this->render('@common/views/prueba-habilidad/view', [
    ...
    public function actionCreate()
    {
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/prueba-habilidad/create', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Actualiza un modelo existente PruebaHabilidad.
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/prueba-habilidad/update', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Busca el modelo PruebaHabilidad en función de su llave primaria.
        * Si no se encuentra el modelo, se emite una excepción HTTP 404.
        * @param integer $id
        * @return PruebaHabilidad el modelo cargado.
        * Devuelve NotFoundHttpException si el modelo no se puede encontrar
        */

        if (($model = PruebaHabilidad::findOne($id)) !== null) {
            return $model;
        } else {
