...
use common\models\search\PruebaCategoria as PruebaCategoriaSearch;
...
/**
 * PruebaCategoriaController Implementa las acciones del CRUD para el modeloPruebaCategoria .
 * */ 
class PruebaCategoriaController extends Controller
{
    ...
    {
        /**
        * Lista todo el modelo PruebaCategoria. 
        * no hay variable de retorno
        */
        $searchModel = new PruebaCategoriaSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('@common/views/prueba-categoria/index', [
    ...
    {
        /**
        * Muestra un modelo único PruebaCategoria. 
        * @param integer $id
        * no tiene variable de retorno
        */
        return $this->render('@common/views/prueba-categoria/view', [
    ...
    public function actionCreate()
    {
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/prueba-categoria/create', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Actualiza un modelo existente PruebaCategoria.
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/prueba-categoria/update', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Busca el modelo PruebaCategoria en función de su llave primaria.
        * Si no se encuentra el modelo, se emite una excepción HTTP 404.
        * @param integer $id
        * @return PruebaCategoria el modelo cargado.
        * Devuelve NotFoundHttpException si el modelo no se puede encontrar
        */

        if (($model = PruebaCategoria::findOne($id)) !== null) {
            return $model;
        } else {
