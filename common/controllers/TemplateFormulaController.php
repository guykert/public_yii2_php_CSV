...
use Yii;
use common\models\TemplateFormula;
use common\models\search\TemplateFormula as TemplateFormulaSearch;
...
/**
 * TemplateFormulaController Implementa las acciones del CRUD para el modeloTemplateFormula .
 * */ 
class TemplateFormulaController extends Controller
{
    ...
    {
        /**
        * Lista todo el modelo TemplateFormula. 
        * no hay variable de retorno
        */
        $searchModel = new TemplateFormulaSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('@common/views/template-formula/index', [
    ...
    {
        /**
        * Muestra un modelo único TemplateFormula. 
        * @param integer $id
        * no tiene variable de retorno
        */
        return $this->render('@common/views/template-formula/view', [
    ...
    public function actionCreate()
    {
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/template-formula/create', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Actualiza un modelo existente TemplateFormula.
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/template-formula/update', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Busca el modelo TemplateFormula en función de su llave primaria.
        * Si no se encuentra el modelo, se emite una excepción HTTP 404.
        * @param integer $id
        * @return TemplateFormula el modelo cargado.
        * Devuelve NotFoundHttpException si el modelo no se puede encontrar
        */

        if (($model = TemplateFormula::findOne($id)) !== null) {
            return $model;
        } else {
