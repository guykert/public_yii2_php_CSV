...
use common\models\search\Comuna as ComunaSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use yii\filters\AccessControl;
use common\models\Usuario;
use common\components\select\ProvinciaComponent;

/**
 * ComunaController Implementa las acciones del CRUD para el modeloComuna .
 * */ 
class ComunaController extends Controller
{
    ...
    {
        /**
        * Lista todo el modelo Comuna. 
        * no hay variable de retorno
        */
        $searchModel = new ComunaSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('@common/views/comuna/index', [
    ...
    {
        /**
        * Muestra un modelo único Comuna. 
        * @param string $id
        * no tiene variable de retorno
        */
        return $this->render('@common/views/comuna/view', [
    ...
    public function actionCreate()
    {
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/comuna/create', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Actualiza un modelo existente Comuna.
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/comuna/update', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Busca el modelo Comuna en función de su llave primaria.
        * Si no se encuentra el modelo, se emite una excepción HTTP 404.
        * @param string $id
        * @return Comuna el modelo cargado.
    ...
    public function actionProvincia()
    {
        ...
        $CursosMoodle = new CursosMoodleComponent();

        echo $CursosMoodle->RecibirInformacion();
