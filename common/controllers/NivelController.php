...
use common\models\search\Nivel as NivelSearch;
...
/**
 * NivelController Implementa las acciones del CRUD para el modeloNivel .
 * */ 
class NivelController extends Controller
{
    ...
    {
        /**
        * Lista todo el modelo Nivel. 
        * no hay variable de retorno
        */
        $searchModel = new NivelSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('@common/views/nivel/index', [
    ...
    {
        /**
        * Muestra un modelo único Nivel. 
        * @param integer $id
        * no tiene variable de retorno
        */
        return $this->render('@common/views/nivel/view', [
    ...
    public function actionCreate()
    {
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/nivel/create', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Actualiza un modelo existente Nivel.
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/nivel/update', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Busca el modelo Nivel en función de su llave primaria.
        * Si no se encuentra el modelo, se emite una excepción HTTP 404.
        * @param integer $id
        * @return Nivel el modelo cargado.
