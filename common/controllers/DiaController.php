...
class DiaController extends Controller
{
    ...
    {
        /**
        * Lista todo el modelo Dia. 
        * no hay variable de retorno
        */
        $searchModel = new DiaSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('@common/views/dia/index', [
    ...
    {
        /**
        * Muestra un modelo único Dia. 
        * @param string $id
        * no tiene variable de retorno
        */
        return $this->render('@common/views/dia/view', [
    ...
    public function actionCreate()
    {
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/dia/create', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Actualiza un modelo existente Dia.
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/dia/update', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Busca el modelo Dia en función de su llave primaria.
        * Si no se encuentra el modelo, se emite una excepción HTTP 404.
        * @param string $id
        * @return Dia el modelo cargado.
