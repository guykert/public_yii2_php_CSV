...
use common\models\search\Ramo as RamoSearch;
...
/**
 * RamoController Implementa las acciones del CRUD para el modeloRamo .
 * */ 
class RamoController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'actions' => ['index','create','update','delete','view','assign'],
                        'allow' => false,
                        'roles' => ['?'],
                    ],
    ...
    {
        /**
        * Lista todo el modelo Ramo. 
        * no hay variable de retorno
        */
        $searchModel = new RamoSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('@common/views/ramo/index', [
    ...
    public function actionView($id)
    {
        ...
        */
        ...
        return $this->render('@common/views/ramo/view', [
    ...
    public function actionCreate()
    {
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/ramo/create', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Actualiza un modelo existente Ramo.
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/ramo/update', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Busca el modelo Ramo en función de su llave primaria.
        * Si no se encuentra el modelo, se emite una excepción HTTP 404.
        * @param integer $id
        * @return Ramo el modelo cargado.
    ...
    public function actionAssign($padreid,$padrename,$hijoid,$hijoname)
    {
        ...
        if(Ramo::getConfirnarCargados($padreid,$hijoid)){
            // Si ya está asignado se reboca la asignación
            Ramo::eliminarHijo($padreid,$hijoid);

        }else{
            // en caos de no estar asignado se asigna
            Ramo::asignarHijo($hijoid,$hijoname,$padreid,$padrename);
