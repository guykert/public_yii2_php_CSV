...
use common\models\search\Configuracion as ConfiguracionSearch;
...
/**
 * ConfiguracionController Implementa las acciones del CRUD para el modeloConfiguracion .
 * */ 
class ConfiguracionController extends Controller
{
    ...
    {
        /**
        * Lista todo el modelo Configuracion. 
        * no hay variable de retorno
        */
        $searchModel = new ConfiguracionSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('@common/views/configuracion/index', [
    ...
    {
        /**
        * Muestra un modelo único Configuracion. 
        * @param string $id
        * no tiene variable de retorno
        */
        return $this->render('@common/views/configuracion/view', [
    ...
    public function actionCreate()
    {
        ...
        /**
        * Crea un nuevo modelo Configuracion.
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/configuracion/create', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Actualiza un modelo existente Configuracion.
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/configuracion/update', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Busca el modelo Configuracion en función de su llave primaria.
        * Si no se encuentra el modelo, se emite una excepción HTTP 404.
        * @param string $id
        * @return Configuracion el modelo cargado.
