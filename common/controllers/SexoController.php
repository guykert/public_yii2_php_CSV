...
use common\models\search\Sexo as SexoSearch;
...
/**
 * SexoController Implementa las acciones del CRUD para el modeloSexo .
 * */ 
class SexoController extends Controller
{
    ...
    {
        /**
        * Lista todo el modelo Sexo. 
        * no hay variable de retorno
        */
        $searchModel = new SexoSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('@common/views/sexo/index', [
    ...
    {
        /**
        * Muestra un modelo único Sexo. 
        * @param integer $id
        * no tiene variable de retorno
        */
        return $this->render('@common/views/sexo/view', [
    ...
    public function actionCreate()
    {
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/sexo/create', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Actualiza un modelo existente Sexo.
        ...
        */
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@common/views/sexo/update', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        /**
        * Busca el modelo Sexo en función de su llave primaria.
        * Si no se encuentra el modelo, se emite una excepción HTTP 404.
        * @param integer $id
        * @return Sexo el modelo cargado.
