<?php 
    ...
    class EjeTematicoComponent extends Component {
        ...
        public function RecibirInformacion()
        {
            ...
            if ((isset($_POST['depdrop_all_params']['id_ramo']) && $_POST['depdrop_all_params']['id_ramo'] > 0)) {
                ...
                if($id != null)
                {
                        ...
                        $list = PruebaEjeTematico::getActivoEjeTematico($ramo_id);
                        ...
                        if (isset($_POST['depdrop_all_params']['eje_tematico_id_selected']) && $_POST['depdrop_all_params']['eje_tematico_id_selected'] > 0) {
                            $selected = $_POST['depdrop_all_params']['eje_tematico_id_selected'];
                        }
                ...
                if($ramo_id != null)
                {
                    ...
                    $out = PruebaEjeTematico::getActivoEjeTematico($ramo_id);
