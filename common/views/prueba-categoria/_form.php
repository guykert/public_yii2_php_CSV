...
/* @var $model common\models\PruebaCategoria */
                ...
                ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <i class="icon-note"></i> 'Mantenedor de Prueba Categoria'                            <div class="card-actions">

                            </div>
                        </div>
                        
                        <div class="card-body">
                        'En este mantenedor podrás administrar los Prueba Categoria, modificarlos o eliminarlos'                            <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?=  $form->field($model, 'contiene_subramos',['template' => $template])->widget(Select2::classname(), [
                                            'data' => Prueba::getCondisional(),
                                            'language' => 'es',
                                            'value' => 'red', // initial value
                                            'options' => ['placeholder' => 'Seleccione opción', 'id'=>'lista'],
                                            'pluginOptions' => [
