...
/* @var $model common\models\search\Alumno */
...
<div class="alumno-search">
    ...
    <?php // echo $form->field($model, 'colegio_predeterminada') ?>

    <?php // echo $form->field($model, 'nombre_scanner_predeterminado') ?>

    <?php // echo $form->field($model, 'template_predeterminado') ?>
