...
<div class="container-fluid">
    ...
    <?= 
        ...
        'panel' => [
            ...
            'type'=>'success',
            'before'=>Html::a('Crear Alumno', ['create'], ['class' => 'btn btn-success']),
            //'footer'=>false
        ],
        'export' => [
            'fontAwesome' => true,
        ...
        'columns' => [
            ...
            [
                'attribute'=>'curso_id',
                'value'=>'usuarioCurso',
                'filter' =>Html::activeDropDownList($searchModel,'curso_id', Curso::getCursosColegioCombo(),['class'=>'form-control','prompt'=>'Selecciona']),
            ],
            ...
            // 'rol_predeterminado',
            // 'anio_predeterminado',
            // 'colegio_predeterminada',
            // 'nombre_scanner_predeterminado',
            // 'template_predeterminado',
        ...
        <?php 
            echo Html::a('<i class="fa fa-download" aria-hidden="true"></i> Carga Archivo Excel', ['cargar-excel'], ['class' => 'btn btn-success'])
        ?>
