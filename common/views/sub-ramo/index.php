...
/* @var $searchModel common\models\search\SubRamo */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Sub Ramos';
...
<div class="container-fluid">
    ...
    <?= 
        ...
        'panel' => [
            ...
            'type'=>'success',
            'before'=>Html::a('Crear Sub Ramo', ['create'], ['class' => 'btn btn-success']),
            //'footer'=>false
        ],
        'export' => [
            'fontAwesome' => true,
        ...
        'columns' => [
            ...
            [
                'attribute'=>'ramo_id',
                'value'=>'ramo.nombre',
                'filter' =>Html::activeDropDownList($searchModel,'ramo_id', SubRamo::getRamoCombo(),['class'=>'form-control','prompt'=>'Selecciona']),
            ],
            'codigo',
            'nombre',
            'descripcion',
