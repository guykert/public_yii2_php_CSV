                ...
                ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <i class="icon-note"></i> 'Mantenedor de Ramo'                            <div class="card-actions">

                            </div>
                        </div>
                        
                        <div class="card-body">
                        'En este mantenedor podrás administrar los Ramo, modificarlos o eliminarlos'                            <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?=  $form->field($model, 'division_menciones',['template' => $template])->widget(Select2::classname(), [
