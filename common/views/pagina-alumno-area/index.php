...
/* @var $searchModel common\models\search\PaginaAlumnoArea */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Pagina Alumno Areas';
...
<div class="container-fluid">
    ...
    <?= 
        ...
        'panel' => [
            ...
            'type'=>'success',
            'before'=>Html::a('Crear Pagina Alumno Area', ['create'], ['class' => 'btn btn-success']),
            //'footer'=>false
        ],
        'export' => [
            'fontAwesome' => true,
        ...
        'columns' => [
            ['class' => 'yii\grid\SerialColumn'],
                [
                    'attribute'=>'pagina_alumno_id',
                    'value'=>'paginaAlumno.nombre',
                    'filter' =>Html::activeDropDownList($searchModel,'pagina_alumno_id', PaginaAlumno::getActivoPaginaAlumno(),['class'=>'form-control','prompt'=>'Selecciona']),
                ],
