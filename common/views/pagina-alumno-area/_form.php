...
/* @var $model common\models\PaginaAlumnoArea */
                ...
                ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <i class="icon-note"></i> 'Mantenedor de Pagina Alumno Area'                            <div class="card-actions">

                            </div>
                        </div>
                        
                        <div class="card-body">
                        'En este mantenedor podrás administrar los Pagina Alumno Area, modificarlos o eliminarlos'                            <hr>
