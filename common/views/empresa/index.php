...
/* @var $searchModel common\models\search\Empresa */
...
<div class="container-fluid">
    ...
    <?= 
        ...
        'panel' => [
            ...
            'type'=>'success',
            'before'=>Html::a('Crear Empresa', ['create'], ['class' => 'btn btn-success']),
            //'footer'=>false
        ],
        'export' => [
            'fontAwesome' => true,
        ...
        'columns' => [
            ...
            [
                'attribute'=>'empresa_tipo_id',
                'value'=>'empresaTipo.nombre',
                'filter' =>Html::activeDropDownList($searchModel,'empresa_tipo_id', Empresa::getEmpresaTipoCombo(),['class'=>'form-control','prompt'=>'Selecciona']),
            ],
            ...
            ['class' => 'yii\grid\ActionColumn',
                ...
                'buttons' => [
                    ...
                    'upload' => function ($url, $model, $key) {
                        ...
                        return Html::a(Icon::show('upload'), ['carga-excel-colegio', 'id'=>$model->id , 'nombre'=>$model->nombre], $options);
                    },
