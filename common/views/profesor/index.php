        ...
        <div class="animated fadeIn">
            ...
            <?= 
                ...
                'panel' => [
                    ...
                    'type'=>'success',
                    'before'=>Html::a('Crear Profesor <i class="iconomantenedor fa fa-plus"></i>', ['create'], ['class' => 'btn btn-primary']),
                //    'footer'=>false
                ],
                'export' => [
                    'fontAwesome' => true,
                ...
                'columns' => [
                    ...
                    ['class' => 'yii\grid\ActionColumn',
                        'template'=>'{horario} {view} {update} {delete}',
                        'buttons' => [
                            ...
                            'horario' => function ($url, $model, $key) {
                                ...
                                return Html::a(Icon::show('calendar'), ['horario-profesor', 'id'=>$model->id , 'nombre'=>$model->nombre], $options);
                            },
