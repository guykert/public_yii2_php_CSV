...
/* @var $model common\models\PaginaAlumno */
                ...
                ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <i class="icon-note"></i> 'Mantenedor de Pagina Alumno'                            <div class="card-actions">

                            </div>
                        </div>
                        
                        <div class="card-body">
                        'En este mantenedor podrás administrar los Pagina Alumno, modificarlos o eliminarlos'                            <hr>
