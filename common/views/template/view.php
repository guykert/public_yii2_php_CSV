...
$this->params['breadcrumbs'][] = ['label' => 'Templates', 'url' => ['index'],'template' => "<li class=\"breadcrumb-item\">{link}</li>\n"];
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            ...
                            <img src="<?= '/admin/img/uploads/templates/' . $model->imagen;?>" style='width: 800px;height: 1100;' alt="admin@bootstrapmaster.com">
