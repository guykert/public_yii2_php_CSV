...
/* @var $searchModel common\models\search\Comuna */
...
<div class="container-fluid">
    ...
    <?= 
        ...
        'panel' => [
            ...
            'type'=>'success',
            'before'=>Html::a('Crear Comuna', ['create'], ['class' => 'btn btn-success']),
            //'footer'=>false
        ],
        'export' => [
            'fontAwesome' => true,
        ...
        'columns' => [
            ...
            [
                'attribute'=>'region_id',
                'value'=>'region.nombre',
                'filter' =>Html::activeDropDownList($searchModel,'region_id', Region::getActivoRegiones(),['class'=>'form-control','prompt'=>'Selecciona']),
            ],
            [
                'attribute'=>'provincia_id',
                'value'=>'provincia.nombre',
                'filter' =>Html::activeDropDownList($searchModel,'provincia_id', Provincia::getActivoProvincia(),['class'=>'form-control','prompt'=>'Selecciona']),
            ],
