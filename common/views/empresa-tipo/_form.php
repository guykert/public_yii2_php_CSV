...
/* @var $model common\models\EmpresaTipo */
                ...
                ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <i class="icon-note"></i> 'Mantenedor de Empresa Tipo'                            <div class="card-actions">

                            </div>
                        </div>
                        
                        <div class="card-body">
                        'En este mantenedor podrás administrar los Empresa Tipo, modificarlos o eliminarlos'                            <hr>
