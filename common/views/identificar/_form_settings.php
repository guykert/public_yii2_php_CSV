                ...
                ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <i class="icon-note"></i> Configuraciones del Usuario<div class="card-actions">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    if(count($cantidadTemplatesUsuario ) > 0){


                                        echo $form->field($model, 'template_predeterminado',['template' => $template])->widget(Select2::classname(), [
                                            'data' => TemplateHijo::getTemplatesAsignadosUsuario(Yii::$app->user->identity->id),
                                            'language' => 'es',
                                            'value' => 'red', // initial value
                                            'options' => ['placeholder' => 'Seleccione Año'],
                                            'pluginOptions' => [
