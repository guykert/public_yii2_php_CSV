...
/* @var $model common\models\PruebaEjeTematico */
                ...
                ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <i class="icon-note"></i> 'Mantenedor de Prueba Eje Tematico'                            <div class="card-actions">

                            </div>
                        </div>
                        
                        <div class="card-body">
                        'En este mantenedor podrás administrar los Prueba Eje Tematico, modificarlos o eliminarlos'                            <hr>
