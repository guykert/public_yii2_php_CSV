...
$this->title = 'Modificar Prueba Eje Tematico: ' . ' ' . $model->id;
...
$this->params['breadcrumbs'][] = ['label' => 'Prueba Eje Tematicos', 'url' => ['index'],'template' => "<li class=\"breadcrumb-item\">{link}</li>\n"];
