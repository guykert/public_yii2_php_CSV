...
$this->title = 'Modificar Template Sub Region: ' . ' ' . $model->id;
...
$this->params['breadcrumbs'][] = ['label' => 'Template Sub Regions', 'url' => ['index'],'template' => "<li class=\"breadcrumb-item\">{link}</li>\n"];
