                    ...
                    <div class="container">
                        <div class="col-md-12 quitar-padding feature-box-2 cuadroexplicativo fondoblanc fadeInDownSmall">
                            <div class="col-md-12">
                                <div class="cajatextoexplicativo1">
                                    ...
                                    <div class="">
                                        <?= Html::a('<i class="fa fa-download icon-white"></i> Descargar Plantilla ', ['descargar-excel', 'prueba_id' => $prueba_id], ['class'=>'btn btn-success   ',' style'=>'color:#fff;']) ?>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-2">
                                    <?= Html::a(' Continuar <i class="iconomantenedor fa fa-arrow-right"></i>', ['carga-subir-excel', 'prueba_id' => $prueba_id], ['class'=>'btn btn-success ',' style'=>'color:#fff;']) ?>
                                </div>
                            </div>
                        </div>
                    </div>
