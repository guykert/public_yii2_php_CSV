                ...
                ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <i class="icon-note"></i> 'Mantenedor de Configuracion'                            <div class="card-actions">

                            </div>
                        </div>
                        
                        <div class="card-body">
                        'En este mantenedor podrás administrar los Configuracion, modificarlos o eliminarlos'                            <hr>
                            <?= $form->errorSummary($model) ?> <!-- ADDED HERE -->
                            <div class="row">
                                <div class="col-md-6">

                                    
                                    <?= $form->field($model, 'anio_academico')->textInput(['maxlength' => true]) ?>

                                    <?= $form->field($model, 'anio_forzado')->textInput() ?>
