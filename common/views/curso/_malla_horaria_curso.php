                ...
                ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <?= Html::a('Crear horario Curso', ['crear-horario-curso','id' => $model->id], ['class' => 'btn btn-success']) ?>
                                    ...
                                    <table class="table table-responsive-sm table-hover table-bordered mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                $MallaHorariaCurso = ArrayHelper::index($MallaHorariaCurso,null, 'hora_desde');

                                                foreach ($MallaHorariaCurso as $key => $horario) {
                                                                            ...
                                                                            ?>
                                                                                ...
                                                                                <td>
                                                                                            ...
                                                                                            <?php
                                                                                                ...
                                                                                                echo Html::a('<div class="cardhorariotop"><div class="cardhorario"><div class="nombreasignaturacard"><i class="fa fa-circle asignaturaicon">&nbsp;</i>&nbsp;'.$MatrizDia["nombre_sub_ramo"] . '</div></div></div>', ['update-horario-curso','curso_id'=>$curso_id,'id_horario'=>$MatrizDia["id"]], []);
