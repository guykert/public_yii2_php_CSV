...
/* @var $model common\models\TipoPrueba */
                ...
                ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <i class="icon-note"></i> 'Mantenedor de Tipo Prueba'                            <div class="card-actions">

                            </div>
                        </div>
                        
                        <div class="card-body">
                        'En este mantenedor podrás administrar los Tipo Prueba, modificarlos o eliminarlos'                            <hr>
