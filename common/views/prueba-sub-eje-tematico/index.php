...
/* @var $searchModel common\models\search\PruebaSubEjeTematico */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Prueba Sub Eje Tematicos';
...
<div class="container-fluid">
    ...
    <?= 
        ...
        'panel' => [
            ...
            'type'=>'success',
            'before'=>Html::a('Crear Prueba Sub Eje Tematico', ['create'], ['class' => 'btn btn-success']),
            //'footer'=>false
        ],
        'export' => [
            'fontAwesome' => true,
        ...
        'columns' => [
            ['class' => 'yii\grid\SerialColumn'],
                ...
                [
                    'value'=>'eje.nombre',
                    'filter' =>Html::activeDropDownList($searchModel,'eje_tematico_id', PruebaEjeTematico::getActivoEjeTematicoCombo($searchModel->ramo_id),['class'=>'form-control','prompt'=>'Selecciona']),
                ],
