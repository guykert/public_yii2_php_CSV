                ...
                ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <i class="icon-note"></i> 'Mantenedor de Prueba Sub Eje Tematico'                            <div class="card-actions">

                            </div>
                        </div>
                        
                        <div class="card-body">
                        'En este mantenedor podrás administrar los Prueba Sub Eje Tematico, modificarlos o eliminarlos'                            <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?= Html::hiddenInput('eje_tematico_id_selected', $model->eje_tematico_id, ['id'=>'eje_tematico_id_selected']); ?> 

                                    <?= $form->field($model, 'eje_tematico_id',['template' => $template])->widget(DepDrop::classname(), [
                                            ...
                                            'pluginOptions' => [
                                                ...
                                                'url'=>Url::to(['/prueba-sub-eje-tematico/eje-tematico']),
                                                // Para definir si el campo está actibo o no
                                                'initialize'=>true,
                                                // valor por defecto si está nulo
                                                'placeholder' => 'Seleccione Eje Temático',
                                                ...
                                                'params'=>['eje_tematico_id_selected']
