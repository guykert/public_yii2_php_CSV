...
$this->params['breadcrumbs'][] = ['label' => 'Rol Tipos', 'url' => ['index'],'template' => "<li class=\"breadcrumb-item\">{link}</li>\n"];
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            En esta parte podrás ver la información que tiene asignada el Tipo de Rol
