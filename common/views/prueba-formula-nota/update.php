...
$this->title = 'Modificar Prueba Formula Nota: ' . ' ' . $model->id;
...
$this->params['breadcrumbs'][] = ['label' => 'Prueba Formula Notas', 'url' => ['index'],'template' => "<li class=\"breadcrumb-item\">{link}</li>\n"];
