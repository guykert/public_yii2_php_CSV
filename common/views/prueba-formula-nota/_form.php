...
/* @var $model common\models\PruebaFormulaNota */
                ...
                ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <i class="icon-note"></i> 'Mantenedor de Prueba Formula Nota'                            <div class="card-actions">

                            </div>
                        </div>
                        
                        <div class="card-body">
                        'En este mantenedor podrás administrar los Prueba Formula Nota, modificarlos o eliminarlos'                            <hr>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <?= $form->field($model, 'multiplicados')->textInput() ?>

                                    <?= $form->field($model, 'sumar')->textInput() ?>
