...
/* @var $model common\models\Bloque */
/* Coloca el título Update más el nombre del modelo */
$this->title = 'Modificar Bloque: ' . ' ' . $model->id;
...
$this->params['breadcrumbs'][] = ['label' => 'Bloques', 'url' => ['index'],'template' => "<li class=\"breadcrumb-item\">{link}</li>\n"];
