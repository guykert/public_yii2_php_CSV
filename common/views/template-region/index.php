...
/* @var $searchModel common\models\search\TemplateRegion */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Template Regions';
...
<div class="container-fluid">
    ...
    <?= 
        ...
        'panel' => [
            ...
            'type'=>'success',
            'before'=>Html::a('Crear Template Region', ['create'], ['class' => 'btn btn-success']),
            //'footer'=>false
        ],
        'export' => [
            'fontAwesome' => true,
        ...
        'columns' => [
            ...
            // 'height',
                 ...
                 ['class' => 'yii\grid\ActionColumn',
                    'template'=>'{clonar} {view} {update} {delete}',
                    'buttons' => [
                        ...
                        'clonar' => function ($url,$model) {
                            $options = array_merge([
                                ...
                                'aria-label' => Yii::t('yii', 'Clonar'),
                                'data-pjax' => '0',
                                'class' => 'btn btn-success',
                            ]);
                            return Html::a(Icon::show('ui-icon-copy'), $url, $options);
