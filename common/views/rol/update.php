...
$this->params['breadcrumbs'][] = ['label' => 'Rols', 'url' => ['index'],'template' => "<li class=\"breadcrumb-item\">{link}</li>\n"];
$this->params['breadcrumbs'][] = ['label' => $model->name, 'url' => ['index'],'template' => "<li class=\"breadcrumb-item\">{link}</li>\n"];
