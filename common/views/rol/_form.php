                ...
                ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <i class="icon-note"></i> 'Mantenedor de Rol'                            <div class="card-actions">

                            </div>
                        </div>
                        
                        <div class="card-body">
                        'En este mantenedor podrás administrar los Rol, modificarlos o eliminarlos'                            <hr>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <?=  $form->field($model, 'type')->widget(Select2::classname(), [
                                        'data' => ['1'=>'Rol','2'=>'Permiso'],
                                        'language' => 'es',
                                        'value' => 'red', // initial value
                                        'options' => ['placeholder' => 'Seleccione Tipo de Rol'],
                                        'pluginOptions' => [
                                            'allowClear' => true,
