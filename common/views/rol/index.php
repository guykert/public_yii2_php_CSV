...
/* @var $searchModel common\models\search\Rol */
...
<div class="container-fluid">
    ...
    <?= 
        ...
        'panel' => [
            ...
            'type'=>'success',
            'before'=>Html::a('Crear Rol', ['create'], ['class' => 'btn btn-success']),
            //'footer'=>false
        ],
        'export' => [
            'fontAwesome' => true,
        ...
        'columns' => [
            ...
            [
                'attribute'=>'type',
                'value'=>'rolTipo.nombre',
                'filter' =>Html::activeDropDownList($searchModel,'type', rol::getRolTipos(),['class'=>'form-control','prompt'=>'Selecciona']),
            ],
            'description:ntext',
            // 'rule_name',
            // 'data:ntext',
        ...
        'columns' => [
            ...
            [
                'attribute'=>'type',
                'value'=>'type_nombre',
                'filter' =>Html::activeDropDownList($searchModel,'type', ['1'=>'Rol','2'=>'Permiso'],['class'=>'form-control','prompt'=>'Selecciona']),
            ],
            'description:ntext',
            // 'rule_name',
            // 'data:ntext',
