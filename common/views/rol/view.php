...
/* @var $model common\models\RolTipo */
...
$this->params['breadcrumbs'][] = ['label' => 'Rol', 'url' => ['index'],'template' => "<li class=\"breadcrumb-item\">{link}</li>\n"];
                                            ...
                                            <?php
                                              $texto_script = "";
                                                ...
                                                foreach($subRoles as $subRol):
                                                    ...
                                                    <tr>
                                                    <td><?php echo $subRol->name ?></td>
                                                    <td><?php echo $subRol->description ?></td>
                                                    ...
                                                    <td class="text-sm-center text-info">
                                                        ...
                                                        if(Rol::getConfirnarCargados($model->name,$subRol->name)){


                                                            echo SwitchInput::widget(['name'=>'subRol_'.$subRol->id, 'value'=>true]);
                                                        }else{

                                                            echo SwitchInput::widget(['name'=>'subRol_'.$subRol->id, 'value'=>false,]);
                                                        }


                                                        $texto_script .= "

                                                            $('input[name=\"subRol_" . $subRol->id . "\"]').on('switchChange.bootstrapSwitch', function(e, s) {
                                                            //  console.log(e.target.value); // true | false
                                                              var _url;
                                                              _url='assign';
                                                              $.ajax({
                                                                 url: _url,
                                                                 data: {subRolid:'" . $subRol->id ."',subRolname:'".$subRol->name."',rolid:'". $model->id . "',rolname:'" . $model->name .  "'},
                                                                 'dataType':'json',
                                                                 'type':'GET',
